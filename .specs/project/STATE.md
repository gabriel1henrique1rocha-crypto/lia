...
- [ ] **PRÓXIMO PASSO — T19 (verificação e2e Mailpit local) + revisão final humana → então merge/`db push`/bootstrap (humano, A-11).** Gate SEC-17: NÃO configurar `SUPABASE_SERVICE_ROLE_KEY` na Vercel.
