...
export const metadata: Metadata = {
  title: 'Autores com deficiência · OLDA',
  description: 'Seção dedicada a autores com deficiência — em construção, será publicada em breve.',
}

export default function AutoresPage() {
  return <SectionPlaceholder title="Autores com deficiência" />
}
